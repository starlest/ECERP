...
using ECERP.Data;
using ECERP.Models.Entities.FinancialAccounting;

namespace ECERP.API.Migrations
{
    [DbContext(typeof(ECERPDbContext))]
    [Migration("20170313080033_Added IsDefault field to LedgerAccount")]
    partial class AddedIsDefaultfieldtoLedgerAccount
    {
