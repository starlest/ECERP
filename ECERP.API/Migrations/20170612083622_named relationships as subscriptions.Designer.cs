...
namespace ECERP.API.Migrations
{
    ...
    [Migration("20170612083622_named relationships as subscriptions")]
    partial class namedrelationshipsassubscriptions
    {
            ...
            modelBuilder.Entity("ECERP.Core.Domain.Stocks.Stock", b =>
                {
                    ...
                    b.HasOne("ECERP.Core.Domain.Warehouses.Warehouse", "Warehouse")
                        .WithMany()
