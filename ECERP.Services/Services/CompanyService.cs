namespace ECERP.Services.Services
{
    using System;
    ...
    using Business.Abstract.FinancialAccounting;
    ...
    public class CompanyService : ICompanyService
    {
        ...
        public void Create(string name, string createdBy)
        {
            ...
            var systemParameter = new CompanySetting
            {
            ...
            _repository.Create(systemParameter);
            _repository.Save();
        }

        public void OpenLastLedgerPeriod(int companyId, string modifiedBy)
        {
            var currentPeriodStartDateParamater = _repository.GetOne<CompanySetting>(
            ...
            _repository.Update(currentPeriodStartDateParamater);
        }

        // TODO: CloseCurrentLedgerPeriod Test Case
